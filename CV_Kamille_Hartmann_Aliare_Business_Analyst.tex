...
\textbf{Indicadores, Métricas e Reportes:} KPIs, dashboards executivos, relatórios gerenciais e de acompanhamento, monitoramento de performance, análise de riscos, Power BI (DAX, Power Query), Excel, Google Sheets.
