...
\textbf{Data Analytics e Business Intelligence:} Power BI (DAX, Power Query), Excel, SQL, análise de dados, visualização de dados, estruturação de bases de dados.
...
Pretensão salarial: R\$ 4.500 a R\$ 5.500 mensais (CLT). Modalidade remota.
