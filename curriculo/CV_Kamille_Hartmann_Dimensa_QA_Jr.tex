...
\begin{center}
  ...
  {\large Suporte e Validação de Sistemas \textbar{} Documentação \textbar{} Análise}\\[10pt]
...
Profissional em formação na área de tecnologia, com experiência em suporte a sistemas, validação de informações, documentação de processos e comunicação de problemas para equipes técnicas. Atua na organização de demandas, elaboração de POPs e materiais de apoio, verificação de consistência de dados e apoio à resolução de ocorrências em ambientes corporativos. Vivência com ServiceNow para gestão e registro de chamados, além de participação em projetos com foco em qualidade de informações e melhoria contínua. Perfil analítico, atento a detalhes, comunicativo e colaborativo, com proatividade e interesse em atuar na área de testes de software.

\section{Experiência Profissional}

\cvrole{Anjuss}{Analista de Suporte de TI}{07/2025 -- Atual}

Atuo no suporte a usuários e sistemas internos, com validação de funcionalidades, organização de demandas e comunicação clara de problemas para a equipe de T.I. Elaboro e atualizo documentações e POPs do sistema para a rede de lojas e para a equipe técnica, evidenciando procedimentos e apoiando a padronização das rotinas. Lidero treinamentos de novos funcionários, verificando a correta aplicação dos processos e a adoção das ferramentas. Desenvolvo dashboards em Power BI para monitoramento de indicadores operacionais, com validação de dados e identificação de inconsistências que impactam a operação e a tomada de decisão.
...
\textbf{Suporte e Qualidade:} Validação de funcionalidades e informações, atenção a detalhes, documentação de processos, POPs, reporte e acompanhamento de ocorrências, comunicação clara de problemas, melhoria contínua.
