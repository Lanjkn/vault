...
\textbf{Análise Técnica de Negócios e Requisitos:} Levantamento e detalhamento de demandas, documentação funcional, elaboração de POPs e manuais, mapeamento de processos, análise de impactos, validação operacional de incidentes, rastreabilidade de solicitações.

\textbf{Pagamentos e Varejo:} PDV, TEF, POS, REDE, Cielo, adquirentes, suporte operacional a terminais de pagamento, fluxo transacional em loja, investigação de incidentes em frente de caixa, contato com adquirentes para tratativa de falhas.
