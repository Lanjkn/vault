...
\textbf{Análise e Indicadores:} Diagnóstico de problemas, KPIs, dashboards, Power BI (DAX, Power Query, insights, Q\&A), Excel, SQL, monitoramento de performance, melhoria contínua.

\textbf{Inteligência Artificial e Mentalidade Digital:} ChatGPT, Copilot, apoio à documentação, organização de ideias, pesquisa e comunicação; interesse em aplicações de IA para transformação de processos e experiências.
