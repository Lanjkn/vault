...
Atuei em projetos de melhoria contínua, PMO e governança de dados em ambiente multinacional industrial, com acompanhamento de portfólio de projetos, cronogramas e entregas. Participei do mapeamento e documentação de processos, análise de riscos e padronização de informações, apoiando a evolução de práticas de governança. Elaborei relatórios executivos e dashboards para monitoramento de KPIs de projetos e iniciativas estratégicas. Utilizei o ServiceNow para gestão de demandas e o Power Automate em automações operacionais. Atuei como ponte entre áreas de TI, operações, fornecedores e stakeholders internacionais, promovendo alinhamento e adoção de melhorias em contextos com múltiplas prioridades.
...
\textbf{Automação e Tecnologia:} Automação de processos (Power Automate), gatilhos e fluxos de trabalho, integração entre sistemas e rotinas analíticas, ServiceNow, Power BI.
